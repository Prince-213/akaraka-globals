                ...
                <div className="row g-4 align-items-center justify-content-between mb-70">
                    <div className="col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="section-title five">
                            ...
                            <h2>Driving Value Across <span>Construction</span>, &amp; <span>Supply Chain</span> Industries.</h2>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-9 col-xl-10 col-lg-11">
                        <ul className="feature-list">
                            <li className="single-feature wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                ...
                                <p>Every shipment from AGRL undergoes strict quality verification to ensure materials meet industrial-grade specifications.</p>
                            </li>
