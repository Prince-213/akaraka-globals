...
const HomePageAboutSection: React.FC<HomePageAboutSectionProps> = ({
  pt = "",
}) => {
        ...
        <div className="container">
          <div className="about-top-area mb-50">
            <div className="row g-4 align-items-center justify-content-between">
              <div
                className="col-xl-8 col-lg-9 wow animate fadeInDown"
                ...
                <div className="about-title-area">
                  ...
                  <div className="video-and-content">
                    ...
                    <div className="content">
                      <p>
                        Akaraka Global Resources Limited (AGRL) has been a
                        leading supplier of industrial chemicals, paints, inks,
                        raw materials, coatings and plastics since 2000. With
                        our motto &quot;AD Asperia Per Astra,&quot; we deliver
                        excellence through quality products and reliable
                        service.
                      </p>
                    </div>
                  </div>
          ...
          <div className="row gy-md-5 gy-4">
            ...
            >
              <div className="about-content">
                <p>
                  Founded on May 21, 2000 by Chinebu Longinus Chigozie, AGRL has
                  grown into a trusted name in Nigeria&apos;s industrial supply
                  sector. We deal in raw materials, chemicals, inks &amp;
                  pigments, coatings, and plastics/polymers, serving
                  manufacturers, contractors, and resellers across the nation.
                </p>
                <ul>
                  <li>
                    <h6>WHO WE ARE</h6>
                    <p>
                      Dealers in industrial chemical, paint, inks, sales
                      suppliers, industrial representatives, imports, exports
                      and general contractors based in Abuja, F.C.T.
                    </p>
                  </li>
                  <li>
                    <h6>OUR MISSION</h6>
                    <p>
                      To provide top-quality industrial materials and chemical
                      products through reliable supply chains, expert
                      representation, and exceptional service to every client.
                    </p>
                  </li>
                </ul>
              </div>
