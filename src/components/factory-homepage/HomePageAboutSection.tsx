                ...
                <div className="container">
                                ...
                                <div className="about-title-area">
                                    ...
                                    <div className="video-and-content">
                                        <a data-fancybox="video-player" style={{ cursor: "pointer" }}
                                            ...
                                            <div className="icon">
                                                <svg className="video-circle" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="77px" viewBox="0 0 206 206"  xmlSpace="preserve">
                                        ...
                                        <div className="content">
                                            <p>Akaraka Global Resources Limited (AGRL) has been a leading supplier of industrial chemicals, paints, inks, raw materials, coatings and plastics since 2000. With our motto &quot;AD Asperia Per Astra,&quot; we deliver excellence through quality products and reliable service.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row gy-md-5 gy-4">
                        <div className="col-lg-5 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                                ...
                                <p>Founded on May 21, 2000 by Chinebu Longinus Chigozie, AGRL has grown into a trusted name in Nigeria&apos;s industrial supply sector. We deal in raw materials, chemicals, inks &amp; pigments, coatings, and plastics/polymers, serving manufacturers, contractors, and resellers across the nation.</p>
                                <ul>
                                    <li>
                                        <h6>WHO WE ARE</h6>
                                        <p>Dealers in industrial chemical, paint, inks, sales suppliers, industrial representatives, imports, exports and general contractors based in Abuja, F.C.T.</p>
                                    </li>
                                    <li>
                                        <h6>OUR MISSION</h6>
                                        <p>To provide top-quality industrial materials and chemical products through reliable supply chains, expert representation, and exceptional service to every client.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-7 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="about-img magnetic-item">
                                <Image width={750} height={580} src="/assets/img/home1/about-img.webp" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
