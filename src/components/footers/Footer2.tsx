          ...
          <div className="container">
            <div className="row g-4 align-items-center">
              <div className="col-md-3">
                <Link href="/industry" className="footer-logo">
                  <Image
                    width={160}
                    height={99}
              ...
              <div className="col-md-5 d-flex justify-content-md-center">
                <p>
                  AGRL - Your trusted partner in industrial chemicals, paints,
                  and raw materials since 2000.
                </p>
              </div>
        ...
        <div className="container">
          <div className="footer-bottom">
            <div className="copyright-area">
              <p>
                Copyright 2025 <Link href="/industry">AGRL</Link> | Akaraka
