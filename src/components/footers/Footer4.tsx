      ...
      <div className="footer-wrapper">
        <div className="container">
          <div className="footer-top-area">
            <div className="row g-lg-4 gy-5 align-items-center justify-content-between">
              <div className="col-md-3">
                <Link href="/metal-industry" className="footer-logo">
                  <Image
                    width={160}
                    height={100}
              ...
              <div className="col-xl-8 col-lg-9 d-flex justify-content-lg-end">
              ...
              <div className="col-lg-3">
                <div className="footer-widget">
                  <div className="footer-content-wrap">
                    <p>
                      AGRL - Your trusted partner in industrial chemicals,
                      paints, and raw materials since 2000.
                    </p>
        ...
        <div className="container">
          <div className="footer-bottom">
            <div className="copyright-area">
              <p>
                Copyright 2025 <Link href="/metal-industry">AGRL</Link> |
                Akaraka Global Resources Limited
              </p>
            </div>
