                ...
                <div className="footer-top-area">
                    <div className="container">
                        <div className="address-area">
                            ...
                            <Link href="/contact" className="location-btn">View All Locations</Link>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row gy-5 align-items-center">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="footer-logo-area">
                                    <Link href="/engineering" className="footer-logo">
                                        <Image width={160} height={95} src="/assets/img/footer-logo2.svg" alt="AGRL Logo" />
                                    </Link>
                                    <p>AGRL - Your trusted partner in industrial chemicals, paints, and raw materials since 2000.</p>
                            ...
                            <div className="col-lg-4 col-md-7">
                                <div className="social-and-address-area">
                                    <div className="footer-widget">
                                        <div className="widget-title">
                                            <h5>SOCIAL</h5>
                                        </div>
                ...
                <div className="container">
                    <div className="footer-bottom">
                        <div className="copyright-area">
                            <p>Copyright 2025 <Link href="/engineering">AGRL</Link> | Akaraka Global Resources Limited</p>
                        </div>
                    </div>
                </div>
            </div>
