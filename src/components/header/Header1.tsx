...
const Header1: React.FC = () => {
  ...
  // Explicitly type arrays and boolean results
  ...
  const serviceRoutesPath: string[] = [
    "/service",
    "/service/style2",
    "/service/style3",
    "/service/style4",
  ...
  const isServiceActive: boolean = serviceRoutesPath.some((path: string) =>
  ...
  const isSProjectPathActive: boolean = projectpaths.some((path: string) =>
    pathname.startsWith(path),
  );

  const innerPagePaths: string[] = [
    "/about",
    "/blog",
    "/blog/details",
    "/blog/sidebar",
  ...
  return (
    <>
        ...
        <div className="right-sidebar-menu-wrap">
          ...
          <div className="sidebar-content-wrap">
            <div className="title-area">
              ...
              <p>
                Reach out to AGRL for quality industrial chemicals, paints, raw
                materials, and general contracting services.
              </p>
            </div>
      ...
      <header
        ref={headerRef}
        className={`header-area style-1 ${state.scrollY > 20 ? "sticky" : ""}`}
      >
