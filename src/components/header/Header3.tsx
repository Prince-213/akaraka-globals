...
interface HeaderState {
  ...
  isLang: boolean;
  scrollY: number; // optional since it's only set after scroll
}
...
const Header3: React.FC = () => {
  ...
  return (
    <>
      ...
      <header
        className={`header-area style-3 ${state.scrollY > 20 ? "sticky" : ""}`}
      >
        <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
          ...
          >
            <div className="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
              <Link href="/oil-gas" className="mobile-logo-wrap">
                <Image
                  width={157}
                  height={34}
                  alt="image"
            ...
            <ul className="menu-list">
                      ...
                      <div className="row gy-lg-5">
                        ...
                        <div className="col-lg-3">
                          ...
                          >
                            ...
                            <h5>
                              <Link href="/metal-industry">Metal Industry</Link>
                            </h5>
                          </div>
                        </div>
                        <div className="col-lg-3">
              ...
              >
                ...
                >
                  ...
                  <li
                    className={pathname === "/service/details" ? "active" : ""}
                  >
              ...
              >
                ...
                >
                  ...
                  <li className={pathname === "/project/metro" ? "active" : ""}>
                  ...
                  <li
                    className={pathname === "/project/infoflow" ? "active" : ""}
                  >
                  ...
                  <li
                    className={pathname === "/project/details" ? "active" : ""}
                  >
                ...
                >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <li
                        className={pathname === "/blog/sidebar" ? "active" : ""}
                      >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <li
                        className={pathname === "/shop-details" ? "active" : ""}
                      >
