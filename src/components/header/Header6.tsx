...
const Header6: React.FC = () => {
  ...
  useEffect(() => {
    document.body.classList.add("engineering-home");
  }, []);
  ...
  const isServiceActive = serviceRoutesPath.some((path) =>
  ...
  const isProjectPathActive = projectPaths.some((path) =>
    pathname.startsWith(path),
  );
  ...
  return (
    <>
                ...
                <div className="single-contact social">
                  <div className="icon">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M2.18506 23H20.5404"
                        strokeMiterlimit={10}
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M14.7053 12H32.8151"
                        strokeMiterlimit={10}
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M2.18506 12H10.1218"
                        strokeMiterlimit={10}
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      ...
                      />
                      <path
                        d="M7.97554 29.1707C7.97554 27.9853 7.01459 27.0244 5.8292 27.0244C4.64382 27.0244 3.68286 27.9853 3.68286 29.1707C3.68286 30.3561 4.64382 31.3171 5.8292 31.3171C7.01459 31.3171 7.97554 30.3561 7.97554 29.1707Z"
                        strokeMiterlimit={10}
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
      ...
      <div
        className={`header-topbar-wrap header-area ${state.scrollY > 20 ? "sticky" : ""}`}
      >
                    ...
                    >
                      <g>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M4.76543 0.468288C4.51373 0.216669 4.17241 0.0753174 3.81651 0.0753174C3.46061 0.0753174 3.11929 0.216669 2.86759 0.468288L1.17959 2.15629C0.699476 2.63632 0.348539 3.22995 0.159403 3.88199C-0.0297335 4.53404 -0.0509266 5.22332 0.0977938 5.88575L0.099136 5.89156C0.599319 7.99162 1.89407 11.3891 5.28977 14.7848C8.68547 18.1805 12.0839 19.4753 14.1848 19.9723L14.1897 19.9732C14.8516 20.1218 15.5402 20.1006 16.1917 19.9117C16.8432 19.7229 17.4363 19.3723 17.916 18.8927C18.4883 18.325 19.1392 17.6741 19.6063 17.207C19.7311 17.0825 19.8301 16.9346 19.8977 16.7717C19.9652 16.6089 20 16.4344 20 16.2581C20 16.0818 19.9652 15.9072 19.8977 15.7444C19.8301 15.5816 19.7311 15.4337 19.6063 15.3091L16.3976 12.1005C16.1459 11.8488 15.8046 11.7075 15.4487 11.7075C15.0928 11.7075 14.7515 11.8488 14.4998 12.1005L12.9402 13.6596C12.8714 13.7284 12.7821 13.773 12.6858 13.7865C12.5895 13.8 12.4914 13.7816 12.4064 13.7343C11.1969 12.9498 10.0732 12.0402 9.05412 11.0205C7.70926 9.6756 6.80687 8.39382 6.34785 7.67576C6.29808 7.59086 6.27784 7.49186 6.29031 7.39424C6.30277 7.29661 6.34724 7.20587 6.41675 7.1362L6.41809 7.13486C6.8543 6.69463 7.49809 6.05128 7.97412 5.57481C8.09892 5.4503 8.19793 5.3024 8.26549 5.13957C8.33305 4.97674 8.36783 4.80218 8.36783 4.62589C8.36783 4.4496 8.33305 4.27505 8.26549 4.11222C8.19793 3.94939 8.09892 3.80148 7.97412 3.67698L4.76543 0.468288ZM4.13282 1.1

                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M10.0802 7.75764C11.315 7.75764 12.3172 8.75979 12.3172 9.99459C12.3172 10.1132 12.3643 10.227 12.4482 10.3109C12.5321 10.3948 12.6459 10.442 12.7646 10.442C12.8832 10.442 12.997 10.3948 13.0809 10.3109C13.1648 10.227 13.2119 10.1132 13.2119 9.99459C13.2119 8.26632 11.8085 6.86285 10.0802 6.86285C9.96155 6.86285 9.84775 6.90999 9.76385 6.99389C9.67995 7.07779 9.63281 7.19159 9.63281 7.31025C9.63281 7.4289 9.67995 7.5427 9.76385 7.6266C9.84775 7.7105 9.96155 7.75764 10.0802 7.75764Z"
                        />
                      </g>
                    </svg>
                    0816-617-5684
        ...
        <header className="style-1 engineering-header">
          <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
            ...
            >
              ...
              <ul className="menu-list">
                ...
                >
                  ...
                  />
                  <div
                    className={`mega-menu ${state.activeMenu === "HOME" ? "d-block" : "none"}`}
                  >
                    <div className="mega-menu-wrap">
                      <div className="container">
                        <div className="row gy-lg-5">
                          ...
                          <div className="col-lg-3">
                            <div
                              className={`single-menu-item ${pathname === "/industry" ? "active" : ""}`}
                            >
                          ...
                          <div className="col-lg-3">
                            <div
                              className={`single-menu-item ${pathname === "/oil-gas" ? "active" : ""}`}
                            >
                              ...
                              <h5>
                                <Link href="/oil-gas">Inks &amp; Pigments</Link>
                              </h5>
                            </div>
                          </div>
                          <div className="col-lg-3">
                            <div
                              className={`single-menu-item ${pathname === "/metal-industry" ? "active" : ""}`}
                            >
                          ...
                          <div className="col-lg-3">
                            <div
                              className={`single-menu-item ${pathname === "/textile" ? "active" : ""}`}
                            >
                              ...
                              <h5>
                                <Link href="/textile">Textile</Link>
                              </h5>
                            </div>
                          </div>
                          <div className="col-lg-3">
                            <div
                              className={`single-menu-item ${pathname === "/engineering" ? "active" : ""}`}
                            >
                          ...
                          <div className="col-lg-3">
                            <div className="single-menu-item">
                              ...
                              <h5>
                                <a href="#">
                                  Furniture <span>Coming Soon</span>
                                </a>
                              </h5>
                            </div>
                          </div>
                          <div className="col-lg-3">
                            <div className="single-menu-item">
                              ...
                              <h5>
                                <a href="#">
                                  Renewable Energy <span>Coming Soon</span>
                                </a>
                              </h5>
                            </div>
                          </div>
                ...
                >
                  ...
                  />
                  <ul
                    className={`sub-menu ${state.activeMenu === "solution" ? "d-block" : "none"}`}
                  >
                    <li className={pathname === "/service" ? "active" : ""}>
                      <Link href="/service">
                        <span>Services Style 01</span>
                      </Link>
                    </li>
                    <li
                      className={pathname === "/service/style2" ? "active" : ""}
                    >
                      <Link href="/service/style2">
                        <span>Services Style 02</span>
                      </Link>
                    </li>
                    <li
                      className={pathname === "/service/style3" ? "active" : ""}
                    >
                      <Link href="/service/style3">
                        <span>Services Style 03</span>
                      </Link>
                    </li>
                    <li
                      className={pathname === "/service/style4" ? "active" : ""}
                    >
                      <Link href="/service/style4">
                        <span>Services Style 04</span>
                      </Link>
                    </li>
                    <li
                      className={
                ...
                <li
                  className={`menu-item-has-children  ${isProjectPathActive ? "active" : ""}`}
                >
                  ...
                  />
                  <ul
                    className={`sub-menu ${state.activeMenu === "project" ? "d-block" : "none"}`}
                  >
                    ...
                    <li
                      className={pathname === "/project/metro" ? "active" : ""}
                    >
                      <Link href="/project/metro">
                        <span>Project Metro</span>
                      </Link>
                    </li>
                    <li
                      className={
                        pathname === "/project/horizontal" ? "active" : ""
                      }
                    >
                      <Link href="/project/horizontal">
                        <span>Project Horizontal</span>
                      </Link>
                    </li>
                    <li
                      className={
                        pathname === "/project/infoflow" ? "active" : ""
                      }
                    >
                      <Link href="/project/infoflow">
                        <span>Project Infoflow</span>
                      </Link>
                    </li>
                    <li
                      className={
                        pathname === "/project/text-down" ? "active" : ""
                      }
                    >
                      <Link href="/project/text-down">
                        <span>Project Text Down</span>
                      </Link>
                    </li>
                    <li
                      className={
                        pathname === "/project/single-slider" ? "active" : ""
                      }
                    >
                      <Link href="/project/single-slider">
                        <span>Project Single Slider</span>
                      </Link>
                    </li>
                    <li
                      className={
                ...
                <li
                  className={`menu-item-has-children  ${isInnerPagePathActive ? "active" : ""}`}
                >
                  <a href="#" className="drop-down">
                    Pages
                    <svg
                  ...
                  <i
                    onClick={() => toggleMenu("innerPage")}
                    className={`bi bi-${state.activeMenu === "innerPage" ? "dash" : "plus"} dropdown-icon`}
                  />
                  <ul
                    className={`sub-menu ${state.activeMenu === "innerPage" ? "d-block" : "none"}`}
                  >
                    ...
                    <li className={pathname === "/product" ? "active" : ""}>
                      ...
                      <i
                        ...
                        className={`d-lg-none d-flex bi bi-${state.activeSubMenu === "product" ? "dash" : "plus"} dropdown-icon`}
                      />
                      <ul
                        className={`sub-menu ${state.activeSubMenu === "product" ? "d-block" : "none"}`}
                      >
                        <li className={pathname === "/product" ? "active" : ""}>
                          <Link href="/product">
                    ...
                    <li>
                      ...
                      <i
                        ...
                        className={`d-lg-none d-flex bi bi-${state.activeSubMenu === "blog" ? "dash" : "plus"} dropdown-icon`}
                      />
                      <ul
                        className={`sub-menu ${state.activeSubMenu === "blog" ? "d-block" : "none"}`}
                      >
                    ...
                    <li
                      className={
                        pathname === "/career" || pathname === "/career-details"
                          ? "active"
                          : ""
                      }
                    >
                      ...
                      />
                      <ul
                        className={`sub-menu ${state.activeSubMenu === "carrer" ? "d-block" : "none"}`}
                      >
                    ...
                    <li>
                      ...
                      />
                      <ul
                        className={`sub-menu ${state.activeSubMenu === "shop" ? "d-block" : "none"}`}
                      >
