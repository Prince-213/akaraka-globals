...
const SidebarHeader: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className={`sidebar-menu ${state.isSidebarOpen ? "active" : ""}`}>
              ...
              <div className="sidebar-menu-wrap">
                <ul className="main-menu">
                  <li>
                    ...
                    >
                      <i
                        className={`bi bi-${state.activeMenu === "HOME" ? "dash" : "plus"}`}
                      />
                    </span>
                    <ul
                  ...
                  <li>
                    ...
                    >
                      <i
                        className={`bi bi-${state.activeMenu === "solution" ? "dash" : "plus"}`}
                      />
                    </span>
                    <ul
                      className={`submenu-list active ${state.activeMenu === "solution" ? "d-block" : "d-none"}`}
                    >
                      <li>
                        <Link href="/service">
                          Services Style 01
                  ...
                  <li>
                    ...
                    >
                      <i
                        className={`bi bi-${state.activeMenu === "project" ? "dash" : "plus"}`}
                      />
                    </span>
                    <ul
                      className={`submenu-list active ${state.activeMenu === "project" ? "d-block" : "d-none"}`}
                    >
                      <li>
                        <Link href="/project">
                          Project Grid
                  ...
                  <li>
                    ...
                    >
                      <i
                        className={`bi bi-${state.activeMenu === "pages" ? "dash" : "plus"}`}
                      />
                    </span>
                    <ul
                      className={`submenu-list active ${state.activeMenu === "pages" ? "d-block" : "d-none"}`}
                    >
                      <li>
                        <Link href="/our-team">
                          Our Team
                      ...
                      <li>
                        ...
                        <span
                          ...
                          className="dropdown-icon2 two active"
                        >
                          <i
                            className={`bi bi-${state.activeSubMenu === "product" ? "dash" : "plus"}`}
                          />
                        </span>
                        <ul
                          className={`submenu-list active ${state.activeSubMenu === "product" ? "d-block" : "d-none"}`}
                        >
                          <li>
                            <Link href="/product">
                              Our Product
                      ...
                      <li>
                        ...
                        >
                          <i
                            className={`bi bi-${state.activeSubMenu === "blog" ? "dash" : "plus"}`}
                          />
                        </span>
                        <ul
                          className={`submenu-list active ${state.activeSubMenu === "blog" ? "d-block" : "d-none"}`}
                        >
                          <li>
                            <Link href="/blog">
                              Blog Grid
                      ...
                      <li>
                        ...
                        >
                          <i
                            className={`bi bi-${state.activeSubMenu === "shop" ? "dash" : "plus"}`}
                          />
                        </span>
                        <ul
                          className={`submenu-list active ${state.activeSubMenu === "shop" ? "d-block" : "d-none"}`}
                        >
                          <li>
                            <Link href="/shop">
                              Shop
