                    ...
                    <div className="col-xl-8 col-lg-9 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="about-title-area">
                            <div className="section-title two">
                                ...
                                <h2>We specialize in chemical sourcing &amp; distribution</h2>
                            </div>
                            <div className="content">
                                <p>Since 2000, AGRL has been the trusted partner for industrial chemicals and raw materials across Nigeria, delivering quality and reliability to manufacturers nationwide.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="about-content-wrapper">
                            <div className="about-content">
                                <h5>WHO WE ARE</h5>
                                <p>AGRL is a trusted chemical supply partner headquartered in Abuja, Nigeria. We specialise in sourcing and distributing key industrial inputs including calcium carbonate, titanium dioxide, acrylic PVA, HPMC, and kaolinite for the paint, construction, and manufacturing sectors.</p>
                            </div>
