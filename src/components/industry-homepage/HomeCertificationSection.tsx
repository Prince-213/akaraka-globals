...
const HomeCertificationSection: React.FC = () => {
    return (
        <div className="home2-certification-section mb-120">
                ...
                <div className="row g-4">
                    <div className="col-lg-3 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="certificate-card">
                            ...
                            <svg className="vector" width={88} height={105} viewBox="0 0 88 105" xmlns="http://www.w3.org/2000/svg">
