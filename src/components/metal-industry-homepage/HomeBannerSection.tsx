    ...
    return (
        <>
            <div className="home4-banner-section">
                <h1>Quality Coatings &amp; Paints for Every Surface</h1>
                <div className="banner-video-area">
                    <div className="video-area">
                        <video autoPlay loop muted playsInline src="assets/video/metal-industry.mp4" />
                    </div>
                    <div className="video-wrapper">
                        <div className="circular-text2">
                            <a href="#" className="play-btn active" style={{ cursor: 'pointer' }}>
            ...
            <div className="logo-section three mb-120">
                    ...
                    <div className="logo-wrap">
                        ...
                        <div className="marquee">
                            <div className="marquee__group">
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-01.webp" alt="" /></a>
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-02.webp" alt="" /></a>
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-03.webp" alt="" /></a>
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-04.webp" alt="" /></a>
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-05.webp" alt="" /></a>
                                <a href="#"><Image width={104} height={50} src="/assets/img/home3/partner-06.webp" alt="" /></a>
                            </div>
