                    ...
                    <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="about-content-wrap">
                            <div className="section-title two">
                                <h2>About Our Inks &amp; Pigments Division</h2>
                                <p>AGRL is a leading supplier of premium inks, pigments, and colorants for industrial printing, packaging, coatings, and specialty chemical applications. From water-based and solvent-based formulations to high-performance pigments, we deliver vibrant, durable solutions backed by global sourcing and technical expertise.</p>
                            </div>
                            <ul>
                                <li>
                                    <div className="single-content">
                                        <h6>WHO WE ARE</h6>
                                        <p>AGRL connects manufacturers and end-users with high-quality ink and pigment supplies across global markets, ensuring reliable distribution and technical support.</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="single-content">
                                        <h6>OUR MISSION</h6>
                                        <p>To be the premier distributor of inks and pigments, delivering consistent quality, vibrant colour solutions, and dependable supply to printing and coatings industries worldwide.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
