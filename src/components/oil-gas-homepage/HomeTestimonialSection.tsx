                ...
                <div className="row g-4 align-items-end justify-content-between mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="col-lg-5">
                        <div className="section-title two white">
                            <h2>Feedback From The Experts</h2>
                        </div>
                    </div>
                                        ...
                                        <div className="row gy-md-5 gy-4 align-items-center justify-content-between">
                                            ...
                                            <div className="col-lg-7">
                                                <div className="testimonial-content">
                                                    ...
                                                    <p>&ldquo;AGRL&rsquo;s ink supply chain is remarkably dependable. Their colour matching precision and consistent batch quality give us confidence in every production run. A partner we rely on without hesitation.&rdquo;</p>
                                        ...
                                        <div className="row gy-md-5 gy-4 align-items-center justify-content-between">
                                            ...
                                            <div className="col-lg-7">
                                                <div className="testimonial-content">
                                                    ...
                                                    <p>&ldquo;The pigment quality from AGRL has transformed our coating formulations. Their technical support team understands our requirements and delivers solutions tailored to our application needs.&rdquo;</p>
                                                    <div className="author-and-social-area">
                                                        <div className="author-area">
                                                            <div className="author-img">
                                                            ...
                                                            <div className="author-content">
                                                                ...
                                                                <span>Director, Prime Paints Nigeria</span>
                                                            </div>
                                                        </div>
                                                        <div className="social-area">
                                                            <a href="https://www.linkedin.com/">
                                        ...
                                        <div className="row gy-md-5 gy-4 align-items-center justify-content-between">
                                            ...
                                            <div className="col-lg-7">
                                                <div className="testimonial-content">
                                                    ...
                                                    <p>&ldquo;We switched to AGRL for our flexographic ink supply and haven&rsquo;t looked back. Consistent viscosity, brilliant colour strength, and on-time delivery across multiple production sites.&rdquo;</p>
                                                    <div className="author-and-social-area">
                                                        <div className="author-area">
                                                            <div className="author-img">
                    ...
                    <div className="row gy-sm-5 gy-4">
                        <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center divider">
                            <div className="single-countdown">
                                ...
                                <span>Ink Supply Solutions</span>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center divider">
                            <div className="single-countdown">
